                ...
                <div class="card-header">
                    <div class="d-flex">
                        ...
                        @if (request('startDate') && request('endDate'))
                            <a href="{{ route('admin.report.keuangan.jurnalumum') }}" class="btn btn-danger btn-sm mr-1"><i
                        ...
                        <form action="{{ route('admin.report.keuangan.bukubesar.cari') }}" method="GET">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="form-btn ml-1">
                                    ...
                                    <a href="{{ route('admin.report.keuangan.bukubesar') }}" class="btn btn-info mt-2"><i
                                ...
                                <tbody>
                                    ...
                                    @foreach ($row->bkk as $data)
                                        <tr class="bg-warning">
                                            ...
                                            @if ($rowsCount > 0)
                                                @if ($data->id < 9)
                                                    <td>KK0000{{ $data->id }}</td>
                                                @elseif ($data->id < 99) <td>KK000{{ $data->id }}</td>
                                                    @elseif ($data->id < 999) <td>KK00{{ $data->id }}</td>
                                                        @elseif ($data->id < 9999) <td>KK0{{ $data->id }}</td>
                                                            @else
                                                                <td>KK{{ $data->id }}</td>
                                                @endif
                                            @endif
