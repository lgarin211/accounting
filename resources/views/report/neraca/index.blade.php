                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-around">
                            <a target="_blank"
                                href="{{ route('admin.report.keuangan.neraca.pdf', ['tempat' => $tempat, 'kodam' => $kodam, 'jabatan_fungsional' => $jabatan_fungsional, 'nama' => $nama, 'pangkat' => $pangkat, 'pangkat' => $pangkat, 'nrp' => $nrp]) }}"
                                        ...
                                        <li>
                                            ...
                                            <div class="form-group">
                                                <label for="" class="text-primary">
                                                    <a
                                                        href="{{ route('admin.report.keuangan.neraca.detail', $row->id) }}">
                                                        Total {{ $row->name }}
                                                    </a>
                                                </label>
                                ...
                                @foreach ($modal->unique('id') as $row)
                                    <ul class="no-bullet">
                                        <li>
                                            ...
                                            @endforeach
                                            <div class="form-group">
                                                <label for="" class="text-primary"><a
                                                        href="{{ route('admin.report.keuangan.neraca.detail', $row->id) }}">Total
                                                        {{ $row->name }}</a></label>
                                                <h4 class="text-right">Rp.
                                                    {{ number_format($row->debit - $row->kredit) }}</h4>
                                            </div>
                                        </li>
